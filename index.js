...
const instagramlu = 'Ane ga punya ig'; // Nama Instagramlu cok
const whatsapplu = '082131022499'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/CommingSoon'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/CommingSoon'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
